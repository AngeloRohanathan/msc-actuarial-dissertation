...
This `final` run is an optional reinsurance-mechanics sensitivity. It
...
The run contains 50 simulations per scenario. Each gross portfolio
...
sensitivity was authorised. The `final` design is 9 scenarios ×
50 simulations × 2 treaty
