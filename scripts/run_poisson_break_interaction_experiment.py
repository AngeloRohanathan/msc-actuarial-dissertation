"""Run the Step 24 Poisson break-interaction experiment."""
...
STEP24_OUTPUT_DIR = Path(
    "outputs/step24_poisson_break_interaction"
)
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Run the Step 24 paired comparison "
            "of baseline and break-interaction "
            "Regularized Poisson reserving models."
        )
    )
...
def main() -> None:
    ...
    run_label = (
        arguments.run_label
        or (
            "step24_poisson_break_interaction_"
